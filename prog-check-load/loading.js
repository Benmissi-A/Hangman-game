...
const checkLoading = () => {
  ...
  if (!fs.existsSync('./src')) {
    console.clear() // Clear affichage
    console.log(chalk.red(`\nError E-DIR-ADD[1] : 'src' folder doesn't exist\n`)) // affichage error
    process.exit(1) // E-DIR : Exit
  }
  // E-DIR-ADD[2] : dico
  if (!fs.existsSync('./src/dico')) {
    console.clear() // Clear affichage
    console.log(chalk.red(`\nError E-DIR-ADD[2] : 'dico' folder doesn't exist\n`)) // affichage error
    process.exit(1) // E-DIR : Exit
  }
  // E-DIR-ADD[3] : game
  if (!fs.existsSync('./src/game')) {
    console.clear() // Clear affichage
    console.log(chalk.red(`\nError E-DIR-ADD[3] : 'game' folder doesn't exist\n`)) // affichage error
    process.exit(1) // E-DIR : Exit
  }
  // E-DIR-ADD[4] : high-score
  if (!fs.existsSync('./src/high-score')) {
    console.clear() // Clear affichage
    console.log(chalk.red(`\nError E-DIR-ADD[4] : 'high-score' folder doesn't exist\n`)) // affichage error
    process.exit(1) // E-DIR : Exit
  }
  // E-DIR-ADD[5] : pics-hangman
  if (!fs.existsSync('./src/pics-hangman')) {
    console.clear() // Clear affichage
    console.log(chalk.red(`\nError E-DIR-ADD[5] : 'pics-hangman' folder doesn't exist\n`)) // affichage error
    process.exit(1) // E-DIR : Exit
  }
  // E-DIR-ADD[6] : pics-hangman
  if (!fs.existsSync('./src/utils')) {
    console.clear() // Clear affichage
    console.log(chalk.red(`\nError E-DIR-ADD[6] : 'utils' folder doesn't exist\n`)) // affichage error
    process.exit(1) // E-DIR : Exit
  }
  ...
  if (!fs.existsSync('./src/dico/dict-fr.txt')) {
    ...
    console.clear() // Clear affichage
    console.log(enotExist) // affichage Error du fichier : e-not-exit.txt
    console.log(chalk.red(`\nError E-FILE-ADD[1] : 'dict-fr.txt' file doesn't exist\n`)) // affichage error
  ...
  if (!fs.existsSync('./src/game/game-fr.js')) {
    ...
    console.clear() // Clear affichage
    console.log(enotExist) // affichage Error du fichier : e-not-exit.txt
    console.log(chalk.red(`\nError E-FILE-ADD[2] : 'game-fr.js' file doesn't exist\n`)) // affichage error
    process.exit(1) // E-FILE-ADD : Exit
  }
  ...
  if (!fs.existsSync('./src/high-score/score-list-fr.json')) {
    ...
    console.clear()
    console.log(enotExist) // affichage Error du fichier : e-not-exit.txt
    console.log(chalk.red(`\nError E-FILE-ADD[3] : 'score-list-fr.json' file doesn't exist\n`)) // affichage error
    process.exit(1) // E-FILE-ADD : Exit
  }
  ...
  if (!fs.existsSync('./src/high-score/scores-fr.js')) {
    ...
    console.log(chalk.red(`\nError E-FILE-ADD[4] : 'scores-fr.js' file doesn't exist\n`)) // affichage error
    process.exit(1) // E-FILE-ADD : Exit
  }
  ...
  if (!fs.existsSync('./src/pics-hangman/best-scores.txt')) {
    ...
    console.clear()
    console.log(enotExist)
    console.log(chalk.red(`\nError E-FILE-ADD[5] : 'best-scores.txt' file doesn't exist\n`)) // affichage error
    process.exit(1) // E-FILE-ADD : Exit
  }
  ...
  if (!fs.existsSync('./src/pics-hangman/bravo.txt')) {
    ...
    console.clear()
    console.log(enotExist)
    console.log(chalk.red(`\nError E-FILE-ADD[6] : 'bravo.txt' file doesn't exist\n`)) // affichage error
    process.exit(1) // E-FILE-ADD : Exit
  }
  ...
  if (!fs.existsSync('./src/pics-hangman/game.txt')) {
    ...
    console.clear()
    console.log(enotExist)
    console.log(chalk.red(`\nError E-FILE-ADD[7] : 'game.txt' file doesn't exist\n`)) // affichage error
    process.exit(1) // E-FILE-ADD : Exit
  }
  ...
  if (!fs.existsSync('./src/pics-hangman/header.txt')) {
    ...
    console.clear()
    console.log(enotExist)
    console.log(chalk.red(`\nError E-FILE-ADD[9] : 'header.txt' file doesn't exist\n`)) // affichage error
    process.exit(1) // E-FILE-ADD : Exit
  }
  ...
  if (!fs.existsSync('./src/pics-hangman/menu.txt')) {
    ...
    console.clear()
    console.log(enotExist)
    console.log(chalk.red(`\nError E-FILE-ADD[10] : 'menu.txt' file doesn't exist\n`)) // affichage error
    process.exit(1) // E-FILE-ADD : Exit
  }
  ...
  if (!fs.existsSync('./src/pics-hangman/pendu.txt')) {
    ...
    console.clear()
    console.log(enotExist)
    console.log(chalk.red(`\nError E-FILE-ADD[11] : 'pendu.txt' file doesn't exist\n`)) // affichage error
    process.exit(1) // E-FILE-ADD : Exit
  }
  ...
  if (!fs.existsSync('./src/utils/functions.js')) {
    ...
    console.clear()
    console.log(enotExist)
    console.log(chalk.red(`\nError E-FILE-ADD[12] : 'functions.js' file doesn't exist\n`)) // affichage error
    process.exit(1) // E-FILE-ADD : Exit
  }
